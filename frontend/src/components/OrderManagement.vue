<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            <Date label="AccountingYearAndMonth" v-model="value.accountingYearAndMonth" :editMode="editMode"/>
            <String label="OrderType" v-model="value.orderType" :editMode="editMode"/>
            <String label="OrderNumber" v-model="value.orderNumber" :editMode="editMode"/>
            <String label="PlaceOfDelivery" v-model="value.placeOfDelivery" :editMode="editMode"/>
            <Date label="FewWeeks" v-model="value.fewWeeks" :editMode="editMode"/>
            <Date label="DueDate" v-model="value.dueDate" :editMode="editMode"/>
            <String label="NumberOfOrderItems" v-model="value.numberOfOrderItems" :editMode="editMode"/>
            <String label="TotalDrinkingCapacity" v-model="value.totalDrinkingCapacity" :editMode="editMode"/>
