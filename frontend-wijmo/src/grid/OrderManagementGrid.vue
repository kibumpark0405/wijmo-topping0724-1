<template>
    <div style="max-height:80vh;">
        ...
        >
            ...
            <wj-flex-grid-column binding="orderNumber" header="orderNumber" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="placeOfDelivery" header="placeOfDelivery" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="fewWeeks" header="fewWeeks" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="dueDate" header="dueDate" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="numberOfOrderItems" header="numberOfOrderItems" width="2*" :isReadOnly="true" align="center" />
            ...
            >
                ...
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">OrderManagement 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
